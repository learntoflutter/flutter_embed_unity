...
/// changes. This is used to work around a problem with the current Android
...
/// the plugin README for more details)
...
class OrientationChangeNotifier extends StatefulWidget {
  ...
  const OrientationChangeNotifier({required this.child});
